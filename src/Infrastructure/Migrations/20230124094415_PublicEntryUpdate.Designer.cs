...
namespace MTS.Infrastructure.Migrations
{
    ...
    [Migration("20230124094415_PublicEntryUpdate")]
    partial class PublicEntryUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MTS.Core.Models.ApplicationUserModel", b =>
                {
            ...
            modelBuilder.Entity("MTS.Core.Models.CategoryModel", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MTS.Core.Models.LoginLogModel", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MTS.Core.Models.PublicEntryModel", b =>
                {
                    ...
                    b.ToTable("PublicEntries");
                });

            modelBuilder.Entity("MTS.Core.Models.RefreshTokenModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MTS.Core.Models.UserRoleModel", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MTS.Core.Models.EntryModel", b =>
                {
                    b.HasOne("MTS.Core.Models.CategoryModel", "Category")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("MTS.Core.Models.RefreshTokenModel", b =>
                {
                    b.HasOne("MTS.Core.Models.ApplicationUserModel", null)
            ...
            modelBuilder.Entity("MTS.Core.Models.UserRoleModel", b =>
                {
                    b.HasOne("MTS.Core.Models.RoleModel", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("MTS.Core.Models.RoleModel", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
