...
const Explorer = () => {
  ...
  return (
    <div className="categories__wrapper flex h-full w-full items-center justify-center">
      <div className="explorer-container flex h-[800px] w-[1024px] flex-row rounded-xl shadow-lg shadow-primaryDark">
        <div
