...
const Categories = () => {
  ...
  const getCategoryBuddy = () => {
    ...
    if (buddy === lastBuddy.current) return getCategoryBuddy(); // repeat if last buddy is equal to current
  ...
  return (
    <div className="categories__container enter-animation">
      <>
        <div className="category add-new" onClick={invokeAddModal}>
      ...
      >
        <EditDocument
          category={categoryToEdit.current}
          closeEditModal={closeEditModal}
          sendRequest={sendEditRequest}
        />
      </BasicModal>
      <BasicModal
        isOpen={shouldAddModalOpen}
        shouldCloseOnOverlayClick={true}
...
const AddDocument = ({ closeAddModal, sendRequest }) => {
  ...
  useEffect(
    () => (modalAddInput.current = document.getElementById("add-modal-input")),
    []
  );
      ...
      <div className="modal-menu">
        ...
        <div className="modal-menu-buttons">
          <div
            ...
            onClick={() => sendRequest(modalAddInput.current.value)}
          >
            Accept
          </div>
